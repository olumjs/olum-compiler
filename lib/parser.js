...
const { isFullArr, id, createScopeHandler, getGlobalMethods, getGlobalProps, libsMap } = require("./helpers");
...
const parser = (str, counter, filePath) => {
  ...
  let {html, comps, anonHandlers} = htmlParser(str, counter, filePath, parentMethods); // html content and all components tags <olum></olum>
  ...
  return {
    ...
    el: el_${currentID},
    incomingPropsProxy: olum.props(_storeKey),
