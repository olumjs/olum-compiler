...
${routes
  .map(({ path, comp }) => `  { path: "${cleanNumbersPrefix(path)}", comp: ${cleanNumbersPrefix(comp)} }`)
  .join(",\n")}
];`;
}
...
const libsMap = {
  development: {
    olum: "/node_modules/olum/dist/olum.js",
    router: "/node_modules/olum-router/dist/router.js"
  },
  production: {
    olum: "olum",
    router: "olum-router"
...
module.exports.libsMap = libsMap;
